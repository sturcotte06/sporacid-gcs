...
public class HomeController
{
    ...
    public String search(@ModelAttribute @Valid SearchForm form, BindingResult result, HttpServletRequest request, @RequestHeader(value = "referer", required = true) final String referer)
    {
