...
{
	/**
	 * Private constant for the session attribute key to access the list of application messages.
	 */
	private static final String cSessionMessagesKey = "applicationMessages";
	
	/**
	 * Private constant for the session attribute key to access the key for this user's identity
	 */
