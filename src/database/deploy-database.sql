...
CREATE TABLE Suivies (Commandites_id int4 NOT NULL UNIQUE, Membres_id int4 NOT NULL UNIQUE, Suivie_Statuts_id int4 NOT NULL, date_suivie timestamp with time zone NOT NULL, commentaire varchar(255) NOT NULL, PRIMARY KEY (Commandites_id, Membres_id));
