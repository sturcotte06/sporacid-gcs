...
CREATE TABLE Membres_Preferences (id  SERIAL NOT NULL, "key" varchar(500) NOT NULL, value varchar(150) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Membres (id  SERIAL NOT NULL, Concentrations_id int4 NOT NULL, Membres_Preferences_id int4, nom varchar(64) NOT NULL, prenom varchar(64) NOT NULL, courriel varchar(255) NOT NULL, code_permanent varchar(15) NOT NULL, actif bool NOT NULL, telephone varchar(16), PRIMARY KEY (id));
...
ALTER TABLE Membres ADD CONSTRAINT FKMembres46393 FOREIGN KEY (Membres_Preferences_id) REFERENCES Membres_PREFERENCES (id);
