...
CREATE TABLE Membres_Clubs_Roles (Roles_id int4 NOT NULL, Membres_Clubs_id int4 NOT NULL, PRIMARY KEY (Roles_id, Membres_Clubs_id));
...
CREATE TABLE Membres_Allergies (Membres_id int4 NOT NULL, Allergies_id int4 NOT NULL, PRIMARY KEY (Membres_id, Allergies_id));
...
CREATE TABLE Suivies (Commandites_id int4 NOT NULL, Membres_id int4 NOT NULL, Suivie_Statuts_id int4 NOT NULL, date_suivie timestamptz NOT NULL, commentaire varchar(255) NOT NULL, PRIMARY KEY (Commandites_id, Membres_id));
...
CREATE TABLE Fournisseurs_Items (Fournisseurs_id int4 NOT NULL, Items_id int4 NOT NULL, code_fournisseur int4 NOT NULL, PRIMARY KEY (Fournisseurs_id, Items_id));
