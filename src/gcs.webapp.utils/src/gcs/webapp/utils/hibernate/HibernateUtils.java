...
/**
 * 
 * @author Simon Turcotte-Langevin and François Gagné
 *
 */
...
{	
	...
	{
		// Get all entities, without aliases or restrictions, and with no pagination
		return getEntities(sessionFactory, classObj, new ArrayList<HibernateAlias>(), new ArrayList<Criterion>(), 
				0, getEntityCount(sessionFactory, classObj));
	}
	 ...
	 */
	public static <E extends AbstractModelObject> Collection<E> getEntities(SessionFactory sessionFactory, Class<E> classObj, 
			Collection<HibernateAlias> aliases, Collection<Criterion> criterions)
	{
		// Get the entities with no pagination
		return getEntities(sessionFactory, classObj, aliases, criterions, 
				0, getEntityCount(sessionFactory, classObj));
	}
