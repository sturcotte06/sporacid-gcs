...
{
    /** */
    private Map<String, Map<String, MainMenu>> availableMenus = new CaseInsensitiveMap<>();
    ...
    public MenuProvider(String menusFolderRelativePath, IMessageLocalizer localizer) throws JDOMException, IOException
    {
        ...
        for (String locale : localizer.getAvailableLocales()) {
            Map<String, MainMenu> menuToLocalize = new CaseInsensitiveMap<>();
     ...
     * @throws JDOMException
     */
    private Map<String, MainMenu> loadApplicationMenus(String messagesFolderAbsolutePath) throws JDOMException,
            IOException
    {
        Map<String, MainMenu> unlocalizedMenus = new CaseInsensitiveMap<>();
